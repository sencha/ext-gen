...
### Next Steps
[Explore the Getting Started with NPM Guide](https://docs.sencha.com/extjs/7.9.0/guides/getting_started/getting_started_with_npm.html)
...
* [Introduction to App Architecture](https://docs.sencha.com/extjs/7.9.0/guides/application_architecture/application_architecture.html)
* [Adding Components to the Ext JS Grid
Resources](https://docs.sencha.com/extjs/7.9.0/guides/components/widgets_widgets_columns.html)
...
* [Ext JS Sample Applications](https://examples.sencha.com/extjs/7.9.0/)
* [Ext JS Component Examples - Classic Toolkit](https://examples.sencha.com/extjs/7.9.0/examples/kitchensink/?classic#all)
* [Ext JS Component Examples - Modern Toolkit](https://examples.sencha.com/extjs/7.9.0/examples/kitchensink/?modern#all)
