...
## Examples
* ext-build generate app --sdk 'Ext/ext-7.5.1' --template 'universalmodern' MyApp ./MyApp
* ext-build gen app -s 'Ext/ext-7.5.1' -t 'universalmodern' MyApp ./MyApp
* eb g a -s 'Ext/ext-7.5.1' -t 'universalmodern' MyApp ./MyApp
...
## Comments
* Tested with Ext JS Version 7.5.1
