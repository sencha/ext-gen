...
## Examples
* ext-build generate app --sdk 'Ext/ext-8.0.0' --template 'universalmodern' MyApp ./MyApp
* ext-build gen app -s 'Ext/ext-8.0.0' -t 'universalmodern' MyApp ./MyApp
* eb g a -s 'Ext/ext-8.0.0' -t 'universalmodern' MyApp ./MyApp
...
## Comments
* Tested with Ext JS Version 7.8.0
